...
if(isset($_POST["usernamecheck"])){
	...
	$sql = "SELECT id FROM coaches WHERE username='$username' LIMIT 1";
...
if(isset($_POST["u"])){
	...
	$sql = "SELECT id FROM coaches WHERE username='$u' LIMIT 1";
    $query = mysqli_query($db_conx, $sql); 
	$u_check = mysqli_num_rows($query);
	// -------------------------------------------
	$sql = "SELECT id FROM coaches WHERE email='$e' LIMIT 1";
    $query = mysqli_query($db_conx, $sql); 
	...
	// END FORM DATA ERROR HANDLING
		...
		$sql = "INSERT INTO coaches (username, email, password, ip, signup, lastlogin, notescheck)       
...
if(isset($_POST["e"])){
	...
	// END FORM DATA ERROR HANDLING
		$sql = "SELECT id, username, password FROM coaches WHERE email='$e' AND activated='1' LIMIT 1";
        $query = mysqli_query($db_conx, $sql);
		...
		if($p != $db_pass_str){
			...
			$sql = "UPDATE coaches SET ip='$ip', lastlogin=now() WHERE username='$db_username' LIMIT 1";
            $query = mysqli_query($db_conx, $sql);
			echo $db_username;
		    exit();
		}
                    ...
                    <div class="full-center">
                        <div class="container">
                            <div class="row row-wrap" data-gutter="60">
                                ...
                                <div class="col-md-4">
                                    <h3 class="mb15">Register as a Coach</h3>
                                    <form name="signupform" id="signupform" onsubmit="return false;">
                                        ...
                                        <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-envelope input-icon input-icon-show"></i>
                                            <label>Email</label>
                                            <input id="email" type="text" onfocus="emptyElement('status')" onkeyup="restrict('email')" maxlength="88" class="form-control" placeholder="e.g. johndoe@gmail.com"/>
                                        </div>
                                        <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                                            <label>Password</label>
