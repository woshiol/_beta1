...
<div id="pageMiddle">
  ...
  <form name="signupform" id="signupform" onsubmit="return false;">
    ...
    <div>
      <a href="#" onclick="return false" onmousedown="openTerms();document.getElementById('pageMiddle').style.height = '600px';">
        OdysseyLife Terms Of Use
      </a>
    </div>
    <div id="terms" style="display:none;">
      <h3>OdysseyLife Terms Of Use</h3>
      <p>Be {o}wesome, please!</p>
    </div>
    <br /><br />
