<?php
	...
	$tbl_prime = "CREATE TABLE IF NOT EXISTS prime_coaching (
	...
	$query = mysqli_query($db_conx, $tbl_prime);
	if ($query === TRUE) {
		echo "<h3>prime_coaching table created OK :) </h3>"; 
	} else {
		echo "<h3>prime_coaching user table NOT created :( </h3>"; 
	}
	////////////////////////////////////
