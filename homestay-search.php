...
<?php include_once("_header.php"); ?>
        ...
        <div class="container">
            <h1 class="page-title">Search for Homestay</h1>
        </div>
            ...
            <form>
                <div class="tabbable">
                    <ul class="nav nav-pills nav-sm nav-no-br mb10" id="myTab">
                        <li class="active"><a href="#flight-search-1" data-toggle="tab">Local Family</a>
                        </li>
                        <li><a href="#flight-search-2" data-toggle="tab">Non-local Homestay</a>
                        </li>
                    </ul>
